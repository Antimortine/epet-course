...
: Тезис в философии сознания, утверждающий, что одно и то же ментальное состояние или свойство (например, боль) может быть реализовано различными физическими системами или структурами (например, мозгом человека, мозгом осьминога, гипотетическим кремниевым мозгом ИИ). Является сильным аргументом против теории тождества типов и в пользу функционализма. (См. [Раздел 1.2](../module1/02-physicalism/))
...
: Подход в философии сознания (разновидность физикализма), утверждающий, что ментальные состояния определяются не их внутренней физической реализацией, а их *функциональной ролью* – их каузальными связями с сенсорными входами, другими ментальными состояниями и поведенческими выходами. (См. [Раздел 1.2](../module1/02-physicalism/))
