...
: Философская позиция, согласно которой сложные системы могут обладать новыми (эмерджентными) свойствами, которые не присущи их составным частям и не могут быть полностью сведены к свойствам и взаимодействиям этих частей, хотя и полностью зависят от них (супервентны). Сознание часто рассматривается как кандидат на эмерджентное свойство мозга. (См. [Раздел 1.2](../module1/02-physicalism/), [Модуль 5](../module5/))
